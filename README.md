...
If you don't want to build yourself, and just want to download Zimbra, the builds I have created can be found [here](https://gitlab.com/iwalker/zimbra-builds)
